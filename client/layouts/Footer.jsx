				...
				<div className="container px-5 py-15 mx-auto">
					<div className="flex flex-wrap items-center md:text-left text-center order-first">
						...
						<div className="lg:w-1/3 md:w-1/3 w-full px-4">
							...
							<p className="text-gray-500 text-sm my-2 md:text-left text-center">Subscribe to our Newsletter to get latest News about Cryptocurrency!
							</p>
						</div>
					</div>
				</div>
						...
						<a className="flex title-font font-medium items-center md:justify-start justify-start text-gray-900">
							<div className={ `${footerStyles.footerBrand}` }>
								<Image
									...
									src={ theme === 'light' ? '/spryDEX-sym-black.png' : '/spryDEX-sym-white.png' }
									alt='spryDex'
									fill
								/>
							</div>
							<span className="ml-3 text-xl">spryDEX</span>
						</a>
						<p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2022 spryDEX —
							<a href="https://twitter.com/omkar__ghodake" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@omkarghodake</a>
						</p>
